...
/**
 * Classifies a thrown exception (from packages/db, packages/storage, or an
 * unexpected runtime error) as retryable or not. Never keyed on
 * error.message strings — always on typed error codes/classes
 * (34_Development_Setup_and_Fourth_Sprint.md §42).
 */
